...
describe("ListCategoryGroupsUseCase", () => {
  ...
  const user2Id = "00000000-0000-4000-8000-000000000102" as UserId;
    ...
    expect(result.categoryGroups.find((g) => g.name === "Income")).toBeUndefined();
  });

  it("should return empty array when user has no groups", async () => {
    const result = await useCase.execute({ userId: "00000000-0000-4000-8000-000000000101" as UserId });
