...
describe("CreateCategoryGroupUseCase", () => {
  ...
  it("should save a group with generated id, userId, name, kind, idealPercentageBasisPoints, sortOrder, isSystem default false, timestamps", async () => {
    ...
    const saved = await repo.findById("00000000-0000-4000-8000-000000000101" as UserId, categoryGroupIdFromString(result.id));
